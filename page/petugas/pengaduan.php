                    ...
                    <div class="card-content">
                        ...
                        <?php 
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn modal-trigger indigo lighten-4" href="#more?id_pengaduan=<?php echo $r['id_pengaduan'] ?>">Tanggapi</a>  
                                    ...
                                    <?php 
                                        ...
                                        <div class="col s12 m6">
                                            <form method="POST">
                                                ...
                                                <div class="col s12 input-field">
                                                    <input type="submit" name="tanggapi" value="Kirim" class="btn petugas right">
                                                </div>
                                            </form>
                                        </div>
                                    <?php	}
