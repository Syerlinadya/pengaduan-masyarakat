<section class="home_content">
    <nav>
        <div class="sidebar-button">
            ...
            <span class="white-text center-align">PENGADUAN</span>
        </div>
    </nav>
    <div class="container">
        <div class="row">
                ...
                <div class="card">
					...
					<?php 
						...
						<tr>
							...
							<td>
								<a class="btn modal-trigger indigo lighten-4" href="#detail?id_pengaduan=<?php echo $r['id_pengaduan'] ?>">Tanggapi</a> 
								<a class="btn amber accent-3" onclick="return confirm('Anda Yakin Ingin Menghapus Y/N')" href="index.php?p=tanggapan_hapus&id_tanggapan=<?php echo $r['id_tanggapan'] ?>">Hapus</a></td>
							</td>

<!-- ------------------------------------------------------------------------------------------------------------------------------------ -->
							<!-- Modal Detail -->
							<div id="detail?id_pengaduan=<?php echo $r['id_pengaduan'] ?>" class="modal">
								...
								<?php 
									...
									<div class="col s12 m6">
										<form method="POST">
											...
											<div class="col s12 input-field">
												<input type="submit" name="tanggapi" value="Kirim" class="btn indigo darken-4 right">
											</div>
										</form>
									</div>
								<?php	}
