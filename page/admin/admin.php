                            ...
                            <tbody>
                                <?php 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn indigo lighten-4 modal-trigger" href="#edit<?php echo $r['id_petugas'] ?>">Edit</a>
                                            <a class="amber accent-3 btn" onclick="return confirm('Anda Yakin Ingin Menghapus Y/N')" href="index.php?p=hapus&id_petugas=<?php echo $r['id_petugas'] ?>">Delete</a>
                                        </td>

                                        <!-- Modal Edit -->
                                        <div id="edit<?php echo $r['id_petugas'] ?>" class="modal">
                                            ...
                                            <?php 
                                                if(isset($_POST['Update'])){
                                                    ...
                                                    if($update){
                                                        ...
                                                        echo "<script>location='index.php?p=admin'</script>";
                                                    }
                                                }
                                            ?>
                                        </div>
                                        ...
                                        <div id="modal1" class="modal">
                                            <div class="modal-content">
                                                ...
                                                <form method="POST">
                                                    ...
                                                    <div class="col s12 input-field">
                                                        <input type="submit" name="input" value="Simpan" class="btn indigo darken-4 right">
                                                    </div>
                                                </form>
