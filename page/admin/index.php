...
<body>
   <div class="sidebar">
     ...
     <ul class="nav_list">
        ...
        <li>
          <a href="index.php?p=masyarakat">
          <i class="material-icons small">people_alt</i>
          <span class="links_name">Masyarakat</span>
          </a>
          <span class="tooltip">Masyarakat</span>
        </li>
        <li>
...
<?php 
		...
		elseif(@$_GET['p']=="tanggapan_hapus"){
			...
			if($query){
				header('location:index.php?p=tanggapan');
			}
		}
		elseif(@$_GET['p']=="admin"){
